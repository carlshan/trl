...
class PPOTrainer(BaseTrainer):
    ...
    def __init__(
        ...
        # Add uncertaintly control
        self.uncertainty_ctl = 0.1  # TODO fix for now
    ...
    def step(
        ...
        Args:
            ...
            scores (List[`torch.FloatTensor`]):
                List of tensors containing the scores.
            uncertainties (List[`torch.FloatTensor`]):
                List of tensors containing the model uncertainties.
    ...
    def compute_rewards(
        ...
        uncertainties: torch.FloatTensor,
    ):
        """
        ...
        for score, logprob, ref_logprob, mask, uncertainty in zip(
            scores, logprobs, ref_logprobs, masks, uncertainties
        ):
